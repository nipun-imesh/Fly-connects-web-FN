...
export default function AdminRegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    if (result.success) {
      setAlertMessage(
        `Admin registered successfully! Admin ID: ${result.adminId}`,
      );
      ...
      {showAlert && (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 animate-scale-in">
            <div
              className={`bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-[90vw] border-2 ${
            ...
            >
              ...
              <p className="text-gray-600 text-center mb-6">{alertMessage}</p>
